...
<mapper namespace="${packageName}.${name?capFirst}Mapper">
    <#if entity.table.associate??>
        <select id="findDtos" resultType="${dtoPackageName}.${name?capFirst}Dto">
            ...
            inner join ${entity.table.associate.targetTableName} on ${entity.table.associate.targetTableName}.${entity.table.associate.targetColumnName} = ${entity.table.name}.${entity.table.associate.sourceColumnName}
        </select>
    </#if>
</mapper>
