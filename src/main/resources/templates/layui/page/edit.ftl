        ...
        <#if formItem.class.simpleName == "InputFormItem">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="${formItem.name}" th:value="${r"${" + name + "." + formItem.name + "}"}" <#if formItem.require>lay-verify="required" lay-reqtext="${formItem.comment}不能为空"</#if> placeholder="请输入${formItem.comment}" class="layui-input">
                </div>
            </div>
