...
layui.define(["jquery", "miniMenu", "element","miniTab", "miniTheme"], function (exports) {
    ...
    var miniAdmin = {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == null) {
                        ...
                        miniAdmin.renderHome(data.data[0]);
        ...
        renderHome: function (data) {
            ...
            $('#layuiminiHomeTabId').html('<span class="layuimini-tab-active"></span><span class="disable-close">' + data.name + '</span><i class="layui-icon layui-unselect layui-tab-close">ဆ</i>');
